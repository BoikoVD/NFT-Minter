        ...
        >
            ...
            {!transparentBorder
                ...
                : transparentBorder === 'left' 
                    ? <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0 z-[0] ">
                        <rect x="1" y="1" width={width >= 2 ? width - 2 : width} height={height >= 2 ? height - 2 : height} rx="10" stroke="url(#paint1_linear_17_755)" strokeWidth="2"/>
                        <defs>
                            <linearGradient id="paint1_linear_17_755" x1={width / 2} y1={(height / 2).toFixed(0)} x2={width} y2={(height / 2).toFixed(0)} gradientUnits="userSpaceOnUse">
                    ...
                    : <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0 z-[0] ">
                        <rect x="1" y="1" width={width >= 2 ? width - 2 : width} height={height >= 2 ? height - 2 : height} rx="10" stroke="url(#paint2_linear_17_755)" strokeWidth="2"/>
                        <defs>
                            <linearGradient id="paint2_linear_17_755" x1="0" y1={(height / 2).toFixed(0)} x2={width / 2} y2={(height / 2).toFixed(0)} gradientUnits="userSpaceOnUse">
