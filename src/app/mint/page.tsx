...
const styles = {
  ...
  section: "flex min-h-screen w-full flex-auto flex-col items-center justify-center pb-6 pt-[100px] md:pt-[150px]",
  contentContainer: "flex flex-col items-center gap-10 p-6 md:p-10 lg:flex-row lg:gap-20",
  ...
  beforeElementOfListItem: "before:absolute before:top-[50%] before:left-0 before:bg-white before:w-[6px] before:h-[6px] before:rounded-full before:translate-y-[-50%]",
}
        ...
        <GradientBox className={styles.contentContainer}>
          ...
          <div className={styles.textBox}>
            ...
            <ul className="mb-10 mt-6">
              <li className={`${styles.listItem} ${styles.beforeElementOfListItem}`}>
